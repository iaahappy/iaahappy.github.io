      ...
      <article>
        ...
        <div className="mt-10 space-y-10 text-left text-lg leading-relaxed text-cm-ink md:text-xl">
          ...
          <section className="space-y-4 border-l-2 border-cm-gold/40 pl-5 md:pl-6">
            ...
            <p>
              발급받으신 서류를 가지고 청목 장애인활동지원 부산진구센터로 연락
              주시면, 수급자 본인 확인, 급여 구간, 희망하시는 서비스 내용을 함께
              꼼꼼히 살펴봅니다.
            </p>
          </section>
          ...
          <section className="space-y-5 border-t border-cm-gold/30 pt-10">
            ...
            <p className="font-medium text-cm-deep">
              장애인 돌봄과 자립, 혼자 고민하지 마세요. 청목 장애인활동지원
              부산진구센터가 함께하겠습니다.
            </p>
            ...
            <div className="border-t border-cm-ink/10 pt-6">
              <h3 className="font-myeongjo text-lg font-bold text-cm-deep">
                동래 소재{" "}
                <span className="text-cm-moss">
                  {disabilityCenterDongnae.title}
                </span>
              </h3>
              <dl className="mt-3 space-y-3 text-base md:text-lg">
                <div>
