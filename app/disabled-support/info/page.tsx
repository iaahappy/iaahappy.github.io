...
export default function DisabledInfoPage() {
  return (
    <article className="mx-auto max-w-3xl px-4 py-16 md:py-24">
      ...
      <div className="mt-10 space-y-8 text-left text-lg leading-relaxed text-cm-ink md:text-xl">
        <p>
          안녕하세요. 사회복지법인 청목원 산하 청목 장애인활동지원센터입니다. 저희
          센터는 신체적·정신적 이유로 일상생활과 사회활동에 도움이 필요한
          장애인분들께 전문적인 돌봄과 활동보조 서비스를 제공하는 기관입니다. 전문
          교육을 이수한 활동지원사가 이용자분께 직접 찾아뵙고, 스스로 살아가는 힘과
          지역사회 안에서의 참여를 가까이에서 돕습니다.
        </p>
        ...
        <p className="border-t border-cm-ink/10 pt-8 font-medium text-cm-deep">
          ...
          그대로, 이용자 한 분 한 분의 곁에서 한결같이 함께하겠습니다.
        </p>
      </div>
    </article>
  );
