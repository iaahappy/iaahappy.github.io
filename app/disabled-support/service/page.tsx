...
export const metadata: Metadata = {
  title: "서비스 안내",
  description: "청목 장애인활동지원센터 서비스 안내",
};
...
const supportRows = [
  {
    ...
    category: "신체활동 지원",
    detail:
      "개인위생 관리, 식사 도움, 실내 이동 보조, 체위 변경 등",
  },
  {
    icon: "🧺",
    category: "가사활동 지원",
  ...
  return (
    <article className="mx-auto max-w-3xl px-4 py-16 md:py-24">
      ...
      <div className="mt-10 space-y-10 text-left text-lg leading-relaxed text-cm-ink md:text-xl">
        <p>
          청목 장애인활동지원센터는 「장애인활동 지원에 관한 법률」에 근거하여,
          전문 교육을 이수한 활동지원사가 이용자의 가정 또는 지정 장소로 직접
          방문해 맞춤형 서비스를 제공합니다.
        </p>
              ...
              <tbody>
                {supportRows.map((row) => (
                  <tr
                    ...
                    className="border-b border-cm-ink/10 last:border-0"
                  >
                    <th scope="row" className="align-top px-4 py-3 font-medium">
